...
export default function ChangePassword() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (currentPassword === newPassword) {
      showToast("New password cannot be the same as current password.", false);
      return;
    }
    ...
    try {
      ...
      if (res.ok) {
        ...
        showToast(data.error || data.detail || "Failed to change password.", false);
      }
    } catch (err) {
      console.error(err);
  ...
  return (
    <div className="h-screen flex flex-col" style={{ background: "#FAF3E7" }}>
      ...
      <div className="flex-1 flex items-center justify-center px-6 pt-16">
        <div className="w-full max-w-md">
            ...
            <form onSubmit={handleSubmit} className="space-y-6 mt-6">
              ...
              <div className="flex items-center gap-4">
                <label
                  ...
                  style={{ color: "#7A6D63", fontFamily: "JetBrains Mono, monospace", fontWeight: 500 }}
                >
                  Password
                </label>
                <div className="relative flex-1">
                  <input
                    ...
                    style={{ ...inputStyle, padding: "0.75rem 2.6rem 0.75rem 1.2rem" }}
                    onFocus={e => (e.currentTarget.style.borderColor = "#B89B5E")}
                    onBlur={e => (e.currentTarget.style.borderColor = "#DCCFC0")}
                  />
                  <div className="absolute right-3 top-1/2 -translate-y-1/2">
                    {eyeBtn(showCurrentPass, () => setShowCurrentPass(!showCurrentPass))}
                  </div>
                </div>
              </div>
              ...
              <div className="flex items-center gap-4">
                <div className="min-w-fit">
                  <label
                    ...
                    style={{ color: "#7A6D63", fontFamily: "JetBrains Mono, monospace", fontWeight: 500, marginBottom: "0.25rem" }}
                  >
                    New Password
                  </label>
                  {newPassword && (
                    <span
                      className="text-xs"
                      style={{ color: getStrengthColor(passwordStrength), fontFamily: "JetBrains Mono, monospace", fontWeight: 600 }}
                    >
              ...
              {newPassword && (
                <div className="flex items-center gap-3 -mt-2 px-1">
                  <div className="flex-1 h-1.5 rounded-full" style={{ background: "#E6DDD2" }}>
                    <div
                ...
                <div className="min-w-fit">
                  ...
                  {confirmPassword && (
                    <span
                      className="text-xs"
                      style={{
                        color: confirmPassword === newPassword ? "#00cc66" : "#cc0000",
                        fontFamily: "JetBrains Mono, monospace",
                        fontWeight: 600,
                      }}
                    >
                      {confirmPassword === newPassword ? "Match" : "No Match"}
                    </span>
                  )}
                </div>
                <div className="relative flex-1">
              ...
              <button
                ...
                style={{
                  background: loading ? "rgba(184,155,94,0.4)" : allOk ? "#B89B5E" : "#DCCFC0",
                  color: allOk ? "#FAF3E7" : "#A89B91",
                  fontFamily: "Orbitron, sans-serif",
                  fontSize: "0.75rem",
                  letterSpacing: "0.18em",
                  boxShadow: allOk ? "0 4px 20px rgba(184,155,94,0.35)" : "none",
                  cursor: loading ? "not-allowed" : "pointer",
                }}
                onMouseEnter={e => { if (allOk && !loading) e.currentTarget.style.background = "#A6874E"; }}
                onMouseLeave={e => { if (allOk && !loading) e.currentTarget.style.background = "#B89B5E"; }}
              >
          ...
          <div className="flex items-center justify-center gap-2 mt-4">
            <Shield className="w-3 h-3" style={{ color: "#A89B91" }} />
